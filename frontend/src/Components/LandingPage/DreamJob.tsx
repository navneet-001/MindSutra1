    ...
    return (
        <div className="flex sm-mx:flex-col-reverse  items-center px-16 bs-mx:px-10 md-mx:px-5">
            <div data-aos="zoom-out-right" className="flex flex-col w-[45%] sm-mx:w-full gap-3">
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-bold leading-tight text-mine-shaft-100 [&>span]:text-bright-sun-400">Connect with <span >top</span> <span>freelancers</span> on Workly</div>
                <div className="text-lg md-mx:text-base sm-mx:text-sm text-mine-shaft-200">Workly is an online platform connecting clients with freelancers for web development, writing, design, and marketing services. Hire the best talent with ease.</div>
