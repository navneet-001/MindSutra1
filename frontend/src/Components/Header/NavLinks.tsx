...
const NavLinks = () => {
    ...
    const links = [
        { name: "Explore Gigs", url: "find-jobs" },
        { name: "Hire Experts", url: "find-talent" },
        { name: "Create Gig", url: "post-job/0" },
        { name: "My Listings", url: "posted-jobs/0" },
        { name: "Work Timeline", url: "job-history" }
    ]
