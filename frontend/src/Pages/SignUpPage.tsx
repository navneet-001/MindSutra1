...
<IconBriefcase className="h-8 w-8" stroke={2.5} />
                ...
                <div className="text-6xl bs-mx:text-5xl md-mx:text-4xl sm-mx:text-3xl font-semibold">MindSutra</div>
            </div>
            <div className="text-2xl bs-mx:text-xl md-mx:text-lg text-mine-shaft-200 font-semibold">Your next opportunity is waiting
</div>
        </div>
        <SignUp  />
        </div>
